...
namespace GeneralFrameSystem.SQL
{
    public class SqlHelper : IMySqlHelper
    {
        ...
        public static string GetConnectionString()
        {
            ...
            return "server=127.0.0.1;user id=root;password=123456;database=generalframe;Charset=utf8;";
        }
        ...
        {
            Console.WriteLine("GetDataTable1 = " + sql);
            using (MySqlConnection conn = new MySqlConnection(GetConnectionString()))
            {
        ...
        {
            Console.WriteLine("GetDataTable2 = " + sql);
